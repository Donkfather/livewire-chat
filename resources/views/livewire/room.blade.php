<div class="h-full">
    ...
    <div class="sm:hidden drawer w-full h-full bg-gray-200 absolute top-0 bottom-0 left-0 z-10" style="max-width:300px">
        @livewire('users')
    </div>
    <div class="flex w-full h-full">
        ...
        <div class="flex flex-col w-full">
            <div class="h-12 px-2 flex-shrink-0 flex items-center justify-end border-b">
                <button id="burgerButton" class="sm:hidden focus:outline-none" onclick="drawer.toggle()">
                    <svg
                        class="w-6 h-auto text-black fill-current"
                        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M0 3h20v2H0V3zm0 6h20v2H0V9zm0 6h20v2H0v-2z"/></svg>
                </button>
